...
const AddCard = ({ setIsOpen, addItemFunction }) => {
    ...
    <>
      <div className="glass-modal">
        <div className="modal-content">
            ...
            <div className="flex-equal">
              ...
              >
                {card["Image URL"] !== undefined ? (
                  <img className="card-image" src={card["Image URL"]}></img>
                ) : (
                  "nothing"
                )}
              </div>
          ...
          <div>
            <button
              className="general-button primary-button action-button"
          ...
          {cardAdded ? <div>{card.Name} added.</div> : <></>}
        </div>
      </div>
    </>
  );
